from core import excepions as exc
...
class S3FileDownloadEException(exc.ServerException): ...
...
class FinnotechUnknownResponseException(exc.ServerException):
    def __init__(self, response: dict) -> None:
        super().__init__(detail='finnotech unknown error', context=response)


class FinnotechServiceUnavailableException(exc.ServerException):
    def __init__(self) -> None:
        super().__init__(detail='finnotecch service unavailable')
