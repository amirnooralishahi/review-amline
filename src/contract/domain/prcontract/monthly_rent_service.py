...
class MonthlyRentService : 
    ...
    def calculate_total_rent(self,data: PRCProtocol)->int: 
        ...
        end_date_j  =j_date.fromgregorian(data=data.end_date)
        rent_schedule = []
    ...
    def get_days_int_month ( self,year:int ,month : int )-> int  :
    ...
    def validate_data ( self, rent_data:PRCProtocol )->PRCProtocol: 
        ...
        return PRCRentData( start_date = rent_data.start_date,
