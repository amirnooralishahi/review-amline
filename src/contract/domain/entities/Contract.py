...
class Contract(BaseEntity):
    ...
    # this field added because owner_id_id is either tenant or landlord and not admin
    # and changing thhat migh brak the system. so we're forced to add an extra field .
    created_by: int
