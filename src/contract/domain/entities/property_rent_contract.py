...
class PropertyRentContract(BaseEntity):
    ...
    def update(
        ...
        self.property_handover_date = (
            property_handover_date or self.property_handover_date
        )
        ...
        self.tenant_family_members_count = (
            tenant_family_members_count or self.tenant_family_members_count
        )
