...
class ContractStatus(BaseEnum): 
    ...
    #ADMIN_APPROVAL = 'ADMIN_APPROVED'#Using COMPLETED  instead 
    ...
    PDF_GENERATED_FAILED = 'PDF_GENERATED_FAILED'
    
class PRContractStep(BaseEnum): 
    DATES_AND_PENALTIES ='DATED_AND_PENALTIES'
    ...
    TENANT_APPROVE='TENANTE_APPROVE'
    TENANT_SIGNATURE = 'TENANTE_SIGNATURE'
    TENANT_COMMISSION = 'TENANTE_COMMISSION' 
    TENANTE_REJECTED = 'TENANTE_REJECTED'
    ...
    LANDLORD_EDIT_REQUEST = 'LANDLORD_EDIT_REQEUEST' 
    # # # # # # # # # # # # # # # # # # 
...
class PRContractState(BaseEnum): 
    ...
    TENANT_EDIT_REQUEST = ' TENANT_EDIT_REQUEST' 
    LANDLORD_REJECTED = 'LANDLORD_REJECTED' 
    LANDLORD_EDIT_REQEUEST= 'LANDLORD_EDIT_REQUEST' 
    ADMIN_REJECTED='ADMIN_REJECTED' 
    # 
    DRAFT='DRAFT' 
    ...
    PENDING_TENANT_SIGNATURE='PEDDING_TENANT_SIGNATURE' 
    # 
    ...
    # 
    PENDING_ADMIN_APPROVAL = 'PENDING+ADMIN_APPROVAL' 
...
class PaymentStatus(BaseEnum): 
    ...
    #payer has asserted that they made the payment but payee has not confrimed receipt.
    ...
    #payee denies having received the peyment 
...
class ChequeCategory(BaseEnum): 
    ...
    IMMPOVABLE_PROPERTY ='IMMPOVABLE_PROPERTY' 
    CASH_MANAGEMENT= 'CASH_MANAGEMENT' 
    CUSTOMS_DUTIES ='CUSTOMS_DUTIES' 
    TAX_DUTIES ='TAX_DUTIES ' 
    GOVERMENTAL_SERVICES='GOVERMENTAL_SERVICES' 
...
class InvoiceItems ( Enum): 
    ...
    TEHRAN_BUYING_COMMISSION = (4,'*',0.01) 
    PROVINCES_BUYING_COMMISSION = (5,'*',0.005)
    RENT_COMMISSION = (6,'*',0.3) 
    MORTAGE_COMMISSION=( 
                        7, 
                        '*' 
                        0.006,)
    #6000 TOMAN PER 1-MILLION UNIT OF MORTGAGE AMOUNT (0.6%)
