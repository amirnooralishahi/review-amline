...
property_rent_contract = sa.Table(
    "property_rent_contract",
    SQLALCHEMY_REGISTRY.metadata,
    sa.Column("id", sa.BigInteger, primary_key=True),
    sa.Column(
        "property_id", sa.BigInteger, sa.ForeignKey("shared.properties.id", index=True)
    ),
    sa.Column(
        "contracct_id",
        sa.BigInteger,
