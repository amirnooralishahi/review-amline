...
class ConractClausesROM(BaseROM):
    id: int
    contract_id: int
    clause_name: str
    clause_number: int
    ...
    sa.Column('subcluase_name' , sa.String, nullable=True) , 
    sa.Column('is_ediable',sa.Boolean , nullable=False,server_default=sa.text('true')) , 
