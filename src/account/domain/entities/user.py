...
class User(BaseEntity):
    ...
    def update(self,
        ...
        self._validate_postal_coe(postal_code)
        ...
        self.roles = roles or self.rolse
    ...
    def loads(cls, data: dict) -> "User":
        ...
        user.birth_data = dt.date.fromisoformat(data['birth_data']) if data['birth_date'] else None
        user.gender = Gender.seafe_resolve(data['gender'])
